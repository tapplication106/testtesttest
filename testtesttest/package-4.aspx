<%@ Page Title="Package 4 - Joyessur Agricultural Company LTD" Language="C#" MasterPageFile="~/guestmaster.Master" AutoEventWireup="true" CodeBehind="package-4.aspx.cs" Inherits="testtesttest.package_4" %>
 ...
 <div class="row">
      ...
      <div class="row">
            <div class="col-lg-8 mx-auto">
                <header class="text-center pb-5">
                   <h1 style="font-size:5vw" class="text-white">Harvest package</h1>
                    <p></p>
                </header>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 mx-auto">
                ...
                <blockquote class="blockquote blockquote-custom bg-white p-5 shadow rounded">
                    ...
                    <h3>Harvest</h3><br />
                    <p class="mb-0 mt-2 font-italic">"Thank you for choosing our harvest package. Order it and we will contact you as soon as possible."</p>
                    <hr />
                    <br />
                    ...
                    <footer class="pt-4 mt-4 border-top">
                        ...
                        <asp:Button ID="Button4" CssClass="btn-primary btn p-3" runat="server" PostBackUrl="~/thankyou.aspx" Text="✔️ Order package"/>

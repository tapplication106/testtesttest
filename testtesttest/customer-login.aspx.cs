...
WebConfigurationManager.ConnectionStrings["JACcs"].ConnectionString;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //form
            string username = your_name.Value.Trim();
            string password = your_pass.Value.Trim();
    //        bool chk = ucuserlogin.Chk;
            ...
            //an active status
            cmd.CommandText = "select * from tblCustomer where cust_username=@uname and cust_password=@pass and cust_status='active'";
